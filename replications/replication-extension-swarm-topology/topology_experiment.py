...
if __name__ == "__main__":
    ...
    fig.savefig("figures/topology_swarm_vs_imitation.png", dpi=150)
    print(f"\nsaved topology_results.json + figures/topology_swarm_vs_imitation.png ({time.time() - start:.0f}s total)")
