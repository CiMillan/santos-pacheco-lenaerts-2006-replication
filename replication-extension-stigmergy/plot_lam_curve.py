...
# Same validated categorical palette as ../replication-extension-swarm-topology/plot_c1_curve.py.
...
def collect_summaries():
    ...
    baseline (../replication-extension-swarm-topology/topology_results.json)."""
